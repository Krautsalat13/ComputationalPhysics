...
# -*- coding: utf-8 -*-
"""
Created on Mon Jun  5 04:24:49 2023
...
def Exercise4(N,dt,M,config,plot, z ="selected"):
    ...
    if plot =="x":
        ...
        plt.tight_layout()
        plt.savefig("images/long_"+str(N)+"_"+str(dt)+"_"+config+".pdf",bbox_inches='tight')
        plt.show()
    elif plot =="E":
        plt.figure(figsize= [16,9])
        plt.grid()
        ...
        plt.tight_layout()
        plt.savefig("images/long_"+str(N)+"_E_"+str(dt)+"_"+config+".pdf",bbox_inches='tight')
        plt.show()
